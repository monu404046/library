        ...
        $.ajax({
            ...
            success:function(data){
               ...
               for(var i in data){
                     ...
                     output+="<div class='container'><div class='row'>'<div class='col-4'> <div class='card-deck'><div class='card text-center'><div class='card-block'><h4 class='card-title'>"+data[i].title+"</h4>"
